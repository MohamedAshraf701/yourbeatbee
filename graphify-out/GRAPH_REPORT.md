...
## Corpus Check
- 662 files · ~2,311,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9501 nodes · 14035 edges · 236 communities detected
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 2551 edges (avg confidence: 0.71)
...
- `GET()` --calls--> `readEngineHealth()`  [INFERRED]
  app/api/health/route.ts → lib/engine.ts
- `DELETE()` --calls--> `clearVoiceProfile()`  [INFERRED]
  app/api/voice/route.ts → lib/voices.ts
- `load_handlers()` --calls--> `AceStepHandler`  [INFERRED]
  engine/worker.py → vendor/ACE-Step-1.5/acestep/handler.py
...
Cohesion: 0.01
Nodes (398): generate_examples(), Generate examples using LM and save to JSON files          Args:         num_exa, main(), AudioSaver, Audio saving and transcoding utility class, Initialize audio saver                  Args:             default_format: Defaul, Save MP3 with explicit ffmpeg settings and 128k/48k defaults., Save audio data to file                  Args:             audio_data: Audio dat (+390 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (293): auto_detect_backend(), build_parser(), _cleanup_dir(), _cleanup_handlers(), _get_vram_info_str(), initialize_handlers(), load_env_config(), load_example_config() (+285 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (216): build_configs(), Config-object construction for ACE-Step Training V2 CLI.  Reads model ``config.j, Find config.json for *variant*, supporting custom folder names.      Checks the, Construct adapter config and TrainingConfigV2 from parsed CLI args.      Returns, _resolve_model_config_path(), _HandlerShim, Minimal shim satisfying the ``LoRATrainer`` constructor.      The original train, Dataset (+208 more)
...
Cohesion: 0.01
Nodes (247): _cleanup_gpu(), main(), fixed subcommand -- Corrected training: continuous timesteps + CFG dropout.  Use, Run the two-pass preprocessing pipeline from the standalone entrypoint.      Arg, Standalone CLI entry point for the ``fixed`` training subcommand.      Supports, Release GPU memory so the process can safely reuse it., Execute the fixed (corrected) training subcommand.      Returns 0 on success, no, run_fixed() (+239 more)
...
Cohesion: 0.01
Nodes (161): _configure_cpu_threads(), configure_cpu_threads_if_needed(), debug_end(), debug_end_for(), debug_end_verbose_for(), debug_log(), debug_log_for(), debug_log_verbose_for() (+153 more)
...
Cohesion: 0.01
Nodes (177): create_help_button(), CreateHelpButtonTests, HelpModalCssTests, NextIdTests, Miscellaneous unit tests for help-content ids, CSS, and button wiring., Tests for the unique id counter., Each call should produce a distinct DOM id suffix., Generated id suffixes should be strings for safe HTML formatting. (+169 more)
...
Cohesion: 0.01
Nodes (119): _is_mlx_available(), ConditioningBatchMixin, AudioCodesMixin, Audio-code parsing and conversion helpers for handler decomposition., Mixin containing audio-code parsing and latent conversion helpers.      Depends, Extract integer audio codes from tokens like ``<|audio_code_123|>``., Convert serialized audio-code string into 25Hz latents., Convert uploaded source audio into serialized audio code tokens. (+111 more)
...
Cohesion: 0.02
Nodes (70): Training Event Handlers Module — Facade.  Re-exports all public symbols from the, auto_label_all(), get_sample_preview(), Dataset operations for the training UI.  Contains handlers for scanning director, Get preview data for a specific sample.      Returns:         Tuple of (audio_pa, Save edits to a sample.      Returns:         Tuple of (table_data, status, buil, Update dataset settings.      Returns:         Updated builder_state., Scan a directory for audio files.      Returns:         Tuple of (table_data, st (+62 more)
...
Cohesion: 0.03
Nodes (67): flowedit_sampling_loop(), apply_cfg_branch(), apply_velocity_clamp(), apply_velocity_ema(), build_timestep_schedule(), draw_fwd_noise(), pack_for_cfg(), Helper primitives for ``flow_edit.flowedit_sampling_loop`` (#1156).  Split out p (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (34): ThemeProvider(), formatTime(), pickMimeType(), saveRecording(), startRecording(), GenerateMusicExecuteMixin, GenerateMusicDecodeMixin, Decode/validation helpers for ``generate_music`` orchestration. (+26 more)
...
Cohesion: 0.03
Nodes (74): cleanup_job_temp_files(), ensure_models_initialized(), Runtime state helpers for API job execution flow., Ensure models are initialized, loading them lazily on first request if needed., Persist non-terminal job progress state in optional local cache.      Args:, Delete temporary upload files tracked for a completed job.      Args:         ap, Persist final job result state in optional local cache.      Args:         app_s, JobRuntimeStateTests (+66 more)
...
Cohesion: 0.04
Nodes (71): _cleanup_gpu(), _dispatch(), _has_subcommand(), main(), Entry point for Side-Step training CLI.      When invoked with a subcommand (``p, Run the two-pass preprocessing pipeline., Run gradient sensitivity estimation., Check if sys.argv contains a recognized subcommand or --help. (+63 more)
...
Cohesion: 0.09
Nodes (45): clip_caption(), clip_lyrics(), compose_caption(), influence_to_guidance(), influence_to_lm_cfg(), job_to_params(), lyrics_budget(), Map studio job fields to ACE-Step GenerationParams values.  This module has no A (+37 more)
...
Cohesion: 0.06
Nodes (29): GPUMonitor, Cached GPU / VRAM monitor for the live training display.  Wraps ``gpu_utils`` wi, Return peak allocated VRAM in MiB (CUDA only)., A point-in-time GPU memory reading., Cached GPU VRAM monitor.      Queries the device at most every ``interval`` seco, Cache device name and total VRAM (these don't change)., Return the latest VRAM snapshot, potentially cached., VRAMSnapshot (+21 more)
...
Cohesion: 0.11
Nodes (31): Page(), GET(), POST(), GET(), GET(), readEngineHealth(), createJob(), getJob() (+23 more)
...
Cohesion: 0.07
Nodes (21): MdToHtmlTests, Markdown conversion unit tests for help-content rendering., Tests for the lightweight Markdown-to-HTML converter., ## headings become <h3> tags., ### headings become <h4> tags., **bold** becomes <strong>., *italic* becomes <em>., `code` becomes <code>. (+13 more)
...
Cohesion: 0.09
Nodes (20): AudioRouteHttpTests, HTTP integration tests for the audio file route., Validate fixed bearer token for audio route integration tests., Integration tests covering real HTTP requests for ``GET /v1/audio``., GET /v1/audio should return 401 without Authorization header., GET /v1/audio should return file bytes for authorized requests., _verify_api_key(), HTTP route for serving generated audio files by path. (+12 more)
...
Cohesion: 0.17
Nodes (7): Unit tests for queue worker loop helper functions., Cleanup loop should log cleanup stats and exit on cancellation., Cleanup loop should log non-cancel exceptions and continue until cancelled., Behavior tests for extracted queue worker helper logic., Success path should emit result+done and cleanup queue bookkeeping., Failure path should mark failed, emit error+done, and perform cleanup., WorkerLoopTests
...
## Knowledge Gaps
- **4122 isolated node(s):** `Map studio job fields to ACE-Step GenerationParams values.  This module has no A`, `Download ACE-Step checkpoints with visible, resumable progress.  ACE-Step's snap`, `Return True when the file has a non-empty JSON safetensors header.`, `Delete corrupt weight files so the next download replaces them.`, `Download a separately hosted LM (0.6B / 4B). 1.7B ships in the main snapshot.` (+4117 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 132`** (3 nodes): `API package intent: external service boundary (transport, auth, request lifecycl`, `__init__.py`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (3 nodes): `main()`, `process_audio()`, `prepare_vae_calibration_data.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (2 nodes): `Constants for ACE-Step Centralized constants used across the codebase`, `constants.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (2 nodes): `Compatibility shim for split help-content test modules.  This file is intentiona`, `help_content_test.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (2 nodes): `Gradio package: web UI composition for ACE-Step controls and outputs.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (2 nodes): `Results Handlers Facade  Thin re-export layer that preserves the original ``resu`, `results_handlers.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (2 nodes): `Results sub-package.  Focused modules for result handling, scoring, batch manage`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (2 nodes): `Results batch-management facade.  This thin compatibility module re-exports deco`, `batch_management.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (2 nodes): `UI i18n package: localization loading and translation helpers.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (2 nodes): `Core package intent: framework-agnostic domain logic for generation and inferenc`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (2 nodes): `LLM package intent: text inference contracts, provider adapters, and routing.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (2 nodes): `System package intent: shared infra helpers (GPU config, models, cache, constant`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (2 nodes): `Audio package intent: reusable audio IO, transforms, and codec utilities.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (2 nodes): `Scoring package: alignment and quality metrics for generated outputs.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (2 nodes): `Dataset package intent: dataset lifecycle modules for runtime and build-time usa`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (2 nodes): `Dataset runtime package intent: dataset access/operations used during app execut`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (2 nodes): `Dataset builder package intent: offline dataset scanning, preprocessing, and ser`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (2 nodes): `Dataset Builder for LoRA Training (facade).  This module preserves the public AP`, `dataset_builder.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (2 nodes): `Compatibility facade for LLM request preparation helpers.`, `job_llm_preparation.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (2 nodes): `HTTP package intent: web app assembly, routes, schemas, and middleware.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (2 nodes): `Jobs package: async task execution, queueing, and job state tracking.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (2 nodes): `ACE-Step Training V2 (Side-Step) -- Corrected LoRA Fine-Tuning CLI  Non-destruct`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (2 nodes): `Wizard flow builders -- facade module.  Re-exports ``wizard_train``, ``wizard_pr`, `flows.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (2 nodes): `CLI package for ACE-Step Training V2.  Provides shared argparse helpers and per-`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (2 nodes): `Backward-compatible re-exports for ACE-Step Training V2 CLI.  Split structure:`, `common.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (2 nodes): `Helpers for optional external text-model configuration flows.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `AceStepHandler` connect `Community 1` to `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 15`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 34`, `Community 37`, `Community 38`, `Community 50`, `Community 54`, `Community 55`, `Community 64`, `Community 67`, `Community 74`, `Community 83`, `Community 93`, `Community 94`, `Community 105`?**
  _High betweenness centrality (0.201) - this node is a cross-community bridge._
- **Why does `LLMHandler` connect `Community 1` to `Community 2`, `Community 100`, `Community 4`, `Community 37`, `Community 6`, `Community 112`, `Community 20`, `Community 55`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `get_global_gpu_config()` connect `Community 2` to `Community 1`, `Community 9`, `Community 10`, `Community 11`, `Community 17`, `Community 18`?**
